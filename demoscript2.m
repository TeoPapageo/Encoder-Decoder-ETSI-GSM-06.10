...
z0 = zeros(160, 1);
d0 = zeros(160, 1);
prevFremResd = zeros(160,1);

for i = 1:k(1)
    
     z0 = y(1 + (160*(i-1)) : 160*(i-1) + 160  );
     
     [LARc,Nc,bc,CurrFrmExFull,CurrFrmSTResd] = RPE_frame_SLT_coder(z0, prevFremResd);
     d0 = RPE_frame_SLT_decoder(LARc,Nc,bc,CurrFrmExFull, prevFremResd);
